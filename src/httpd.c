...
/* $Id: httpd.c,v 1.175 2005/04/03 17:14:11 johans Exp $ */
...
"$Id: httpd.c,v 1.175 2005/04/03 17:14:11 johans Exp $ Copyright 1995-2005 Sven Berkvens, Johan van Selst";
#endif
...
#ifdef AUTH_LDAP
int
check_group (LDAP* ld, char* ldapdn, char* user, char* group)
{
	...
	if (ldap_search_s (ld, ldapdn, LDAP_SCOPE_SUBTREE, filter, attrs, 0, &res) != LDAP_SUCCESS)
		goto leave;
...
int
check_auth_ldap(FILE* authfile, char* user, char* pass)
{
